...
export const metadata: Metadata = {
  ...
  openGraph: {
    siteName: "DOTTO TV",
    title: "Publicitate | DOTTO TV",
    description: "Promovați-vă brandul pe DOTTO TV — televiziunea județului Constanța. Acoperire TV și digitală națională.",
    url: `${SITE_URL}/publicitate`,
    type: "website",
    locale: "ro_RO",
    images: [{ url: `${SITE_URL}/images/og-default.jpg`, width: 1200, height: 630, alt: "Publicitate DOTTO TV" }],
  },
  twitter: {
    card: "summary_large_image",
    site: "@dottotv",
    title: "Publicitate | DOTTO TV",
    description: "Promovați-vă brandul pe DOTTO TV — televiziunea județului Constanța.",
